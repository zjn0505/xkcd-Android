...
public class DotsView extends View {
    ...
    private void updateInnerDotsPosition() {
        ...
        if (currentProgress == 0) {
            ...
            this.currentDotSize2 = (float) LikeUtils.mapValueFromRangeToRange(currentProgress, 0.2f, 0.5f, maxDotSize, 0.3 * maxDotSize);
        } else {
            this.currentDotSize2 = (float) LikeUtils.mapValueFromRangeToRange(currentProgress, 0.5f, 1f, maxDotSize * 0.3f, 0);
        }
